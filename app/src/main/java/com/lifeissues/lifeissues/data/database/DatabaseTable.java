...
*/
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Log.w(TAG, "Upgrading com.lifeissues.lifeissues.data.database from version " + oldVersion + " to "
    ...
    /**
     * Performs a com.lifeissues.lifeissues.data.database query.
    ...
    private Cursor query(String selection, String[] selectionArgs, String[] columns) {
         ...
         * actual columns in the com.lifeissues.lifeissues.data.database, creating a simple column alias mechanism
    ...
    public boolean addFavouriteIssue(String issueName, String verses){
        ...
        // Inserting Row
        db.close(); // Closing com.lifeissues.lifeissues.data.database connection

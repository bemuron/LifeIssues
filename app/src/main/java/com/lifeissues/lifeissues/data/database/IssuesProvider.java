 ...
 */
public class IssuesProvider extends ContentProvider {
    String TAG = "IssuesProvider";
    private AppExecutors mExecutors;

    public static String AUTHORITY = "com.lifeissues.lifeissues.data.database.IssuesProvider";
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // to get definitions...
        matcher.addURI(AUTHORITY, "issues", SEARCH_ISSUES);
        matcher.addURI(AUTHORITY, "issues/#", GET_ISSUE);
        // to get suggestions...
      ...
      String[] columns = new String[] {
       ...
       /* SearchManager.SUGGEST_COLUMN_SHORTCUT_ID,
        ...
        mExecutors.diskIO().execute(() ->{
            cursor = LifeIssuesRepository.getInstance().getWordMatches(finalQuery, columns);
        });
    ...
    private Cursor search(String query) {
      ...
      return LifeIssuesRepository.getInstance().getWordMatches(query, columns);
    }
    ...
    private Cursor getWord(Uri uri) {
      ...
      return LifeIssuesRepository.getInstance().getIssue(rowId);
    }

    private Cursor getAllIssues(Uri uri) {
        //String rowId = uri.getLastPathSegment();
        String[] columns = new String[] {
        ...
        return LifeIssuesRepository.getInstance().getAllIssues(columns);
    }
